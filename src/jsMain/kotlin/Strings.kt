val sentilens = Project(
    title = "Sentilens",
    subtitle = "multiplatform diary app",
...
val runTracker = Project(
    title = "Run Tracker",
    subtitle = "Run Tracker - простое приложение для бега",
    description = "Простое и интуитивно понятное приложение для бега и ходьбы. Отличительной особенностью является возможность самостоятельно формировать интервальные тренировки для бега и ходьбы! Самостоятельно выбирайте дистанцию или время для каждого из интервалов тренировки. Подходит для начинающих бегать и тех, кто восстанавливается после.",
    image = listOf(
